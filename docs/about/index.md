...
ALCF was developed at the University of Canterbury with support from the
New Zealand Deep South National Science Challenge for the purpose
of evaluation of climate models based on automatic lidar and ceilometer (ALC)
observations. ALCF has not yet been peer-reviewed. The current release
is a beta release.
